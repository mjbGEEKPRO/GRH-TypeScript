...
function Magement() {
  ...
  const charger = async () => {
    const res1 = await axios.get("http://127.0.0.1:8000/api/users");
    setUser(res1.data);
    const res2 = await axios.get("http://127.0.0.1:8000/api/users");
    setTeams(res2.data);
    const res3 = await axios.get("http://127.0.0.1:8000/api/users");
    setRole(res3.data);
    const res4 = await axios.get("http://127.0.0.1:8000/api/users");
    setPermission(res4.data);
  };
      ...
      <div class="container px-6 py-8 mx-auto">
        ...
        <div class="mt-6 space-y-8 xl:mt-12">
          <div class="flex items-center justify-between max-w-2xl px-8 py-4 mx-auto border cursor-pointer rounded-xl dark:border-gray-700">
            ...
            <h2 class="text-2xl font-semibold text-gray-500 sm:text-4xl dark:text-gray-300">
